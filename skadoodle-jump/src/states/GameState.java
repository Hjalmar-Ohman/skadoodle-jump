 ...
 *
 * States are: menu, playing, highscore
 *
...
public abstract class GameState {
	 ...
	 * @param color The color of the backgrou	nd
	 *
	...
	public void drawBg(GraphicsContext g) {
		...
		g.drawImage(bgImg, 0, 0, SCREEN_WIDTH, SCREEN_HEIGHT);
	...
	public abstract void loadBgImg();
